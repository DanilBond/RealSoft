...
$("#window-1").resize((e) => {
    ...
    if (w < 1350) {
        ...
        // $("#window-1 .scroll.active").addClass("o-a-h");
        // $("#window-1 .scroll.active").addClass("min-w-1484");
    } else {
        $("#window-1 .scroll_flex").removeClass("d-block");
        $("#window-1 .scroll.active").removeClass("mw-100");
        // $("#window-1 .scroll.active").removeClass("o-a-h");
        // $("#window-1 .scroll.active").removeClass("min-w-1484");
    }
    ...
    if (w < 1104) {
        $("#window-1 .window__sort-btn")
            ...
            .addClass("mb-10")
            .addClass("ml-0");
        $("#window-1 .window__action-btn").addClass("mr-10");
    } else {
        $("#window-1 .window__sort-btn")
            .removeClass("mt-10")
            .removeClass("mb-10")
            .removeClass("ml-0");
        $("#window-1 .window__action-btn").removeClass("mr-10");
    }
    ...
    if (w < 511) {
        $("#window-1 .window__search")
            ...
            .addClass("mb-10")
            .addClass("ml-0");
        $("#window-1 .window__sort-btn").addClass("w-280");
        $("#window-1 #dropdown-sort").addClass("w-280");
        $("#window-1 .window__registration-btn").addClass("w-280");
        $("#window-1 #dropdown-reg").addClass("w-280");
        $("#window-1 .window__search input").addClass("w-280");
        $("#window-1 .ok").addClass("m-0");
        $("#window-1 .status").addClass("m-0");
    } else {
        $("#window-1 .window__search")
            .removeClass("mt-10")
            .removeClass("mb-10")
            .removeClass("ml-0");
        $("#window-1 .window__sort-btn").removeClass("w-280");
        $("#window-1 #dropdown-sort").removeClass("w-280");
        $("#window-1 .window__registration-btn").removeClass("w-280");
        $("#window-1 #dropdown-reg").removeClass("w-280");
        $("#window-1 .window__search input").removeClass("w-280");
        $("#window-1 .ok").removeClass("m-0");
        $("#window-1 .status").removeClass("m-0");
    }

    if (w < 418) {
        $("#window-1 .window__routes").addClass("fz-9");
        $("#window-1 .window__icons").addClass("w-100px");
        $("#window-1 .window__images").addClass("w-14");
    } else {
        $("#window-1 .window__routes").removeClass("fz-9");
        $("#window-1 .window__icons").removeClass("w-100px");
    ...
    if (w < 332) {
        ...
        $("#window-1 .window__action-btn")
            ...
            .addClass("mt-10")
            .addClass("w-200");
        $("#window-1 #dropdown-action").addClass("w-200");

        $("#window-1 .window__registration").addClass("ml-0");

        $("#window-1 .window__search input").addClass("w-200");
        $("#window-1 .window__registration-btn").addClass("w-200");
        $("#window-1 #dropdown-reg").addClass("w-200");
        $("#window-1 .window__sort-btn").addClass("w-200");
        $("#window-1 #dropdown-sort").addClass("w-200");

        $("#window-1 .window__registration-btn").addClass("fz15");

        $("#window-1 .window__nav").addClass("ml-0");

        // $(".window__sort-btn").addClass("w-136");
        // $(".window__registration-btn").addClass("w-136");
        ...
        $("#window-1 .window__search input").removeClass("w-200");
        $("#window-1 #dropdownMenuButton3").removeClass("w-200");
        $("#window-1 .window__sort-btn").removeClass("w-200");
        $("#window-1 #dropdown-sort").removeClass("w-200");
        $("#window-1 .window__registration-btn").removeClass("w-200");
        $("#window-1 #dropdown-reg").removeClass("w-200");

        $("#window-1 .window__registration-btn").removeClass("fz15");

        $("#window-1 .window__nav").removeClass("ml-0");

        // $(".window__sort-btn").removeClass("w-136");
        // $(".window__registration-btn").removeClass("w-136");
        // $(".window__search input").removeClass("w-136");
    }
});
...
$("#window-2").resize((e) => {
    ...
    if (w < 560) {
        ...
        $("#window-2 .ok").addClass("m-0");
        $("#window-2 .status2").addClass("m-0");
    } else {
        $("#window-2 .window__action-btn").removeClass("mb-10");
        $("#window-2 .ok").removeClass("m-0");
        $("#window-2 .status2").removeClass("m-0");
    }
    ...
    if (w < 518) {
        ...
        $("#window-2 .window__sort-btn").addClass("w-266");
        $("#window-2 #dropdown-sort").addClass("w-266");

        $("#window-2 .window__action-btn").addClass("w-266");
        $("#window-2 #dropdown-action").addClass("w-266");
    } else {
        ...
        $("#window-2 .window__sort-btn").removeClass("w-266");
        $("#window-2 #dropdown-sort").removeClass("w-266");

        $("#window-2 .window__action-btn").removeClass("w-266");
        $("#window-2 #dropdown-action").removeClass("w-266");
    }
    ...
    if (w < 335) {
        ...
        $("#window-2 #dropdown-sort").addClass("w-200");

        $("#window-2 .window__action-btn").addClass("w-200");
        $("#window-2 #dropdown-action").addClass("w-200");

        $("#window-2 .window__registration").addClass("ml-0");

        $("#window-2 .window__search input").addClass("w-200");

        $("#window-2 .window__nav").addClass("ml-0");
    } else {
        $("#window-2 .window__left p").removeClass("fz15");
        $("#window-2 .window__sort-btn").removeClass("w-200");
        $("#window-2 #dropdown-sort").removeClass("w-200");

        $("#window-2 .window__action-btn").removeClass("w-200");
        $("#window-2 #dropdown-action").removeClass("w-200");

        $("#window-2 .window__registration").removeClass("ml-0");

        $("#window-2 .window__search input").removeClass("w-200");
...
$("#window-3").resize((e) => {
    ...
    if (w < 537) {
        ...
        $("#window-3 .ok").addClass("m-0");
        $("#window-3 .status3").addClass("m-0");
    } else {
        ...
        $("#window-3 .ok").removeClass("m-0");
        $("#window-3 .status3").removeClass("m-0");
    }
