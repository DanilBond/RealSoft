        ...
        (function () {
            ...
            var statisticData = {
                ...
                datasets: fillChartJsColors("line", [
                    {
                        label: "Income in USD",
                        strokeColor: LobiAdmin.fadeOutColor("#FAC032", 20),
                        data: [
                            140, 125, 210, 125, 170, 130, 190, 160, 140, 210,
                            175, 250,
                        ],
                    },
                    {
                        label: "Income in EUR",
                        strokeColor: LobiAdmin.fadeOutColor(
                            LobiAdmin.DEFAULT_COLOR,
                            60
                        ),
                        data: [
                            50, 90, 100, 110, 160, 120, 130, 140, 175, 110, 125,
                            170,
                        ],
                    },
                ]),
            ...
            $("#dashboard-statisticts-panel").on(
                ...
                function (ev) {
                    ...
                    statistictsChart = new Chart(
                        statistictsChart.chart.ctx
                    ).Line(statisticData, options);
                }
            );
        })();
            ...
            var data = [
                {
                    value: 970,
                    color: COLOR1,
                    highlight: LobiAdmin.fadeOutColor(
                        COLOR1,
                        FADEOUT_COLOR_FACTOR
                    ),
                    label: "Shoes",
                },
                {
            ...
            $("#dashboard-events").on(
                ...
                function (ev, lobiPanel) {
                    ...
                    cal.fullCalendar(
                        "option",
                        "height",
                        cal.find(".fc-view-container").outerWidth() / ratio
                    );
                }
            );
        })();
