        ...
        datasets: fillChartJsColors("line", [
          {
            ...
            data: [140, 125, 210, 125, 170, 130, 190, 160, 140, 210, 175, 250],
          },
          {
            label: "Income in EUR",
            strokeColor: LobiAdmin.fadeOutColor("#FAC032", 60),
            data: [50, 90, 100, 110, 160, 120, 130, 140, 175, 110, 125, 170],
          },
        ]),
      };
      ...
      $("#dashboard-events .panel-body").fullCalendar({
        ...
        eventRender: function (event, element, view) {
          if (event.description) {
            element.append(
              '<span class="fc-description">' + event.description + "</span>"
            );
          }
        },
        events: [
